# Django settings for asteriskcdrdb project.
import os
...
STATIC_ROOT = os.path.join(PROJECT_DIR, "static/generated/").replace('\\','/')
...
SECRET_KEY = '2x5mmok&e=v5y3o6wmmtv+1(yz+8@h9a2k)a2*4p3n26#z&ve_'
